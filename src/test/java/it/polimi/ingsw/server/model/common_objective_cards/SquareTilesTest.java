...
class SquareTilesTest {
    ...
    void Normal() {
        ...
        CommonObjectiveCard squareTiles = new SquareTiles(1, 2);
        assertEquals(0, squareTiles.calculatePoints(bookshelf));
    ...
    @Test
    void DoubleSquareTilesOverlapped() {
        Tile[][] tile = new Tile[][]{
                {new Tile(1, GREEN, "C_0"), new Tile(1, GREEN, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, GREEN, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, GREEN, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, YELLOW, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, YELLOW, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
    ...
    @Test
    void doubleSquaredTiles() {
        Tile[][] tile = new Tile[][]{
                {new Tile(1, GREEN, "C_0"), new Tile(1, YELLOW, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, YELLOW, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, YELLOW, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")},
                {new Tile(1, GREEN, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, PINK, "C_0"), new Tile(1, DARK_BLUE, "C_0"), new Tile(1, LIGHT_BLUE, "C_0")}
        };
        ...
        bookshelf.setPositionTiles(tile);
        CommonObjectiveCard squareTiles = new SquareTiles(1, 2);
        assertEquals(8, squareTiles.calculatePoints(bookshelf));
    }
